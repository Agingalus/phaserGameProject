...
PirateFunctionsPlugin.prototype = {
        ...
        onGameObjectClicked: function(pointer, gameObject) {
            ...
            switch (gameObject.name) {
                ...
                case "repairShipBtn":
                    ...
                    let cost = (playerShip.maxHitPoints - playerShip.hitPoints) / 5;
        ...
        tortugaTextFunction: function() {
            ...
            this.tortugaShipRepairText = this.scene.add.text(370, 415, 'Max Cost: ' + ((playerShip.maxHitPoints - playerShip.hitPoints) / 5), TortugaStyle);
        ...
        updateTortugaDisplay: function() {
            ...
            this.tortugaShipRepairText.setText('Max Cost: ' + ((playerShip.maxHitPoints - playerShip.hitPoints) / 5), TortugaStyle);
